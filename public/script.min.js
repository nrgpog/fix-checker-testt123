        ...
        if(result.success && result.results[0]) {
            ...
            if(cardResult.status === 'Live' && !cardResult.message?.includes('Unable')) {
                ...
                await this.addCard('dead', card, {
                    ...
                    bank: cardResult.card?.bank || 'Unknown',
                    country: cardResult.card?.country || { name: 'Unknown', emoji: '🌍' }
                });
                this.stats.deads++;
            }
    ...
    div.innerHTML = `
        <div class="card-content">
            <div class="card-header">
                ...
                <button class="copy-btn" onclick="copyToClipboard('${card} | ${status} | ${result.message} | ${result.bank} | ${result.country?.emoji} | .gg/aeolous')">
            ...
            <div class="card-status">
                ...
                <span class="card-details-inline">
                    ${result.message} | ${result.bank} | ${result.country?.emoji} | .gg/aeolous
                </span>
            </div>
        </div>
    `;
